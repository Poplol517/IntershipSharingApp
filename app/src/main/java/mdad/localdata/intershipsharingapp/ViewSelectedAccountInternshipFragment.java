 ...
 * Use the {@link ViewSelectedAccountInternshipFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ViewSelectedAccountInternshipFragment extends Fragment {
    ...
    public ViewSelectedAccountInternshipFragment() {
     ...
     * @return A new instance of fragment ViewSelectedAccountInternshipFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ViewSelectedAccountInternshipFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_view_selected_account_internship, container, false);
    ...
    private void fetchInternships() {
        ...
        Log.d("SelectedAccountUserId", "Current User ID: " + currentUserId);
                    ...
                    for (String internship : internships) {
                        if (!internship.isEmpty()) {
                            ...
                            if (details.length >= 11) {
                                ...
                                Log.d("PostUserId", "Post User ID: " + postUserId);
